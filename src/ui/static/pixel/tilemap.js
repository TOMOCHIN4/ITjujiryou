...
//   souther: 6×2 化粧板 + ワイングラス (背面ビュー、バロック・マホガニー)
//   yuko:    6×3 U 字 (コ字) 秘書デスク。両端 3 深 wing + 中央前 2 深 front + 中央後 1 深窪み。
//            窪み = アセット上端 (back 側) が透過。ユウコは奥から窪みに入る。
//            スタイル = 白大理石 + クローム + ゴールドライン (サザンと対照)。
// 三兄弟は旧アセット (3:1) のまま再配置を保留。
